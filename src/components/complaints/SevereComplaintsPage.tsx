...
const mockSevereComplaints: SevereComplaint[] = [
  {
    ...
    raw_comment: 'พนักงานไม่สุภาพ พูดจาก้าวร้าว ไม่ให้ความช่วยเหลือ เมื่อลูกค้ามีปัญหาเรื่องโอนเงิน ทีมให้รู้สึกไม่ปลอดภัย จะไม่ใช้บริการธนาคารนี้อีก',
    category_tags: '1.1 ความสุภาพและมารยาทของพนักงาน, 1.2 ความเอาใจใส่ในการให้บริการลูกค้า',
    sentiment: 'negative',
    severity: 'high'
  },
  {
    ...
    raw_comment: 'ระบบธนาคารล่ม 3 ชั่วโมง ไม่มีความชัดเจนใดๆ พนักงานไม่มีการแจ้งล่วงหน้า ต้องรอแบบไม่รู้ปลายทาง เสียเวลาทำงาน',
    category_tags: '3.1 ระบบ Core ของธนาคาร, 1.3 ความสามารถในการตอบคำถามหรือให้คำแนะนำ',
    sentiment: 'negative',
    severity: 'high'
  },
  {
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="text-muted-foreground">
        รายงานข้อร้องเรียนที่สำคัญจากลูกค้า - แสดงเฉพาะความคิดเห็นเชิงลบที่มีความรุนแรงสูง
      </div>
